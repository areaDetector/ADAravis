...
#aravisCameraConfig("$(PORT)", "PointGrey-18402100")
#dbLoadRecords("$(ARAVISGIGE)/db/PGR_Blackfly_50S5C.template","P=$(PREFIX),R=cam1:,PORT=$(PORT),ADDR=0,TIMEOUT=1")
...
aravisCameraConfig("$(PORT)", "Allied Vision Technologies-50-0503419258")
dbLoadRecords("$(ARAVISGIGE)/db/AVT_Manta_G507C.template","P=$(PREFIX),R=cam1:,PORT=$(PORT),ADDR=0,TIMEOUT=1")
